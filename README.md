...
> [!NOTE]
> 1. This project has been configured for "Standard Unlocked Shulman" (package name: `StandardUnlockedShulman`). All tokens have been replaced with actual values.
